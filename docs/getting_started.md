...
* Python **3.10** or **3.11**.
* [uv](https://docs.astral.sh/uv/) (recommended) — a fast Python package
...
neighbor statistics, z-scores …). See [Theoretical concepts](theoretical_concepts.md)
for what is compared and why it stays identical.
...
!!! tip
    ...
    See [How-to guides](how_to_guides.md) for the full recipe set, and the rendered
    [example notebooks](examples.md) for complete real-data pipelines.
